<template>
  ...
  <section class="px-3 py-4 space-y-4 text-black text-sm">
    <p class="">This helps hide potentially mature videos. No filter is 100% accurate.</p>
    <p class="">This settings only applies to this browser.</p>
    ...
    <template v-if="selectedOptions.restrictedMode.enabled">
      <p class="">Restricted Mode lock prevents others from changing the Restricted Mode settings on this browser</p>
      <p class="">Lock Restricted Mode on this browser</p>
    </template>
  </section>
</template>
